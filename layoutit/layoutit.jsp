...
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
      <a  href="#"><img src="img/favicon.png"> 可视化布局<span class="label">BETA</span></a>
      <button data-target=".navbar-collapse" data-toggle="collapse" class="btn btn-default navbar-btn" type="button"></button>
...
<div class="container">
      ...
      <div class="sidebar-nav">
        <ul class="nav nav-list accordion-group">
          ...
          <li style="display: list-item;" class="rows" id="estRows">
            <div class="lyrow ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span>
              <div class="preview">
        ...
        <ul class="nav nav-list accordion-group">
          ...
          <li style="display: none;" class="boxes" id="elmBase">
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> 
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <span class="btn-group"> <a class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" href="#">对齐 <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li class="active"><a href="#" rel="">默认</a></li>
                <li class=""><a href="#" rel="text-left">靠左</a></li>
                <li class=""><a href="#" rel="text-center">居中</a></li>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"> <a class="btn btn-default btn-xs" href="#" rel="pull-right">右对齐</a> </span>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <a class="btn btn-default btn-xs" href="#" rel="unstyled">无样式</a> <a class="btn btn-default btn-xs" href="#" rel="inline">嵌入</a> </span>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <a class="btn btn-default btn-xs" href="#" rel="dl-horizontal">竖向对齐</a> </span>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <span class="btn-group"> <a class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" href="#">样式 <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li class="active"><a href="#" rel="">默认</a></li>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <a class="btn btn-default btn-xs" href="#" rel="form-inline">嵌入</a> </span>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"> </span>
              <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button></span>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"> <span class="btn-group"> <a class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" href="#">样式 <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li class="active"><a href="#" rel="">默认</a></li>
        ...
        <ul class="nav nav-list accordion-group">
          <li class="nav-header"><i class="glyphicon glyphicon-plus"></i> 组件
            <div class="pull-right popover-info"><i class="glyphicon glyphicon-question-sign"></i>
              <div class="popover fade right">
                <div class="arrow"></div>
                <h3 class="popover-title">帮助</h3>
          ...
          <li style="display: none;" class="boxes" id="elmComponents">
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"> <span class="btn-group"> <a class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" href="#">方向<span class="caret"></span></a>
              <ul class="dropdown-menu">
              ...
              <div class="view">
                <div class="btn-group">
                  <button class="btn" type="button"><i class="glyphicon-align-left"></i></button>
                  <button class="btn" type="button"><i class="glyphicon-align-center"></i></button>
                  <button class="btn" type="button"><i class="glyphicon-align-right"></i></button>
                  <button class="btn" type="button"><i class="glyphicon-align-justify"></i></button>
                </div>
              </div>
            </div>
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <a class="btn btn-default btn-xs" href="#" rel="dropup">上拉</a> </span>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove glyphicon--white"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <span class="btn-group"> <a class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" href="#">样式 <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li class=""><a href="#" rel="nav-tabs">线框</a></li>
                <li class=""><a href="#" rel="nav-pills">图钉</a></li>
              </ul>
              </span> <a class="btn btn-default btn-xs" href="#" rel="nav-stacked">切换格式</a> </span>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <a class="btn btn-default btn-xs" href="#" rel="well">嵌入</a> </span>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <span class="btn-group"> <a class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" href="#">尺寸 <span class="caret"></span></a>
              <ul class="dropdown-menu">
              ...
              </span> <span class="btn-group"> <a class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" href="#">位置 <span class="caret"></span></a>
              <ul class="dropdown-menu">
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label-important"><span class="glyphicon glyphicon-remove"></span>删除</a> <span class="drag"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <span class=""> <a class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" href="#">样式 <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li class="active"><a href="#" rel="">默认</a></li>
              ...
              <div class="view"> <div class="input-group">
  ...
  <input type="text" class="form-control" placeholder="Username">
	...
	<div class="input-group">
     ...
     <a href="#close" class="removeOption label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a>
    </div>
    <div class="input-group">
      <span class="input-group-addon">
        <input type="radio">
      ...
      <input type="text" class="form-control">
    <a href="#close" class="removeOption"><i class="glyphicon glyphicon-remove"></i>删除</a>
    </div> </div>
            </div>
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <span class="btn-group"> <a class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" href="#">样式 <span class="caret"></span></a>
              <ul class="dropdown-menu">
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <a class="btn btn-default btn-xs" href="#" rel="well">嵌入</a> </span>
              ...
              <div class="view">
                <div class="hero-unit" contenteditable="true">
                  ...
                  <p><a class="btn btn-default btn-primary btn-lg" href="#">参看更多 »</a></p>
                </div>
              </div>
            </div>
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span>
                  ...
                  <li class="span4">
                    <div class="thumbnail"> <img alt="300x200" src="img/people.jpg">
                      <div class="caption" contenteditable="true">
                        ...
                        <p><a class="btn btn-default btn-primary" href="#">浏览</a> <a class="btn" href="#">分享</a></p>
                      </div>
                    </div>
                  </li>
                  <li class="span4">
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"> <span class="btn-group"> <a class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" href="#">样式 <span class="caret"></span></a>
              ...
              </span> <a class="btn btn-default btn-xs" href="#" rel="progress-striped">条纹</a> <a class="btn btn-default btn-xs" href="#" rel="active">动画</a> </span>
        ...
        <ul class="nav nav-list accordion-group">
          <li class="nav-header"><i class="glyphicon glyphicon-plus"></i> 交互组件 <span class="label label-important">NEW!</span>
            <div class="pull-right popover-info"><i class="glyphicon glyphicon-question-sign"></i>
              <div class="popover fade right">
                <div class="arrow"></div>
                <h3 class="popover-title">帮助</h3>
          ...
          <li style="display: none;" class="boxes mute" id="elmJS">
              ...
              <div class="view"> 
                ...
                <div id="myModalContainer" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  ...
                  <div class="modal-footer">
                    ...
                    <button class="btn btn-default btn-primary" contenteditable="true">保存设置</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <a class="btn btn-default btn-xs" href="#" rel="navbar-inverse">Inverse</a> 
              <!--a class="btn btn-default btn-xs" href="#" rel="navbar-fixed-top">Navbar fixed top</a--> 
              </span>
              <div class="preview">导航栏</div>
              <div class="view">
                <div class="navbar">
                  <div class="navbar-inner">
                    <div class="container"> <a data-target=".navbar-responsive-collapse" data-toggle="collapse" class="btn btn-default navbar-btn"> <span class="glyphicon-bar"></span> <span class="glyphicon-bar"></span> <span class="glyphicon-bar"></span> </a> <a href="#" class="navbar-brand" contenteditable="true">网站名</a>
            ...
            <div class="box box-element ui-draggable"> <a href="#close" class="remove label label-important"><i class="glyphicon glyphicon-remove"></i>删除</a> <span class="drag label"><i class="glyphicon glyphicon-move"></i>拖动</span> <span class="configuration"><button type="button" class="btn btn-default btn-xs" data-target="#editorModal" role="button" data-toggle="modal">编辑</button> <span class="btn-group"> <a class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" href="#">位置 <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li class="active"><a href="#" rel="">默认</a></li>
...
<div class="modal hide fade" role="dialog" id="editorModal">
  ...
  <div class="modal-footer"> <a id="savecontent" class="btn btn-default btn-primary" data-dismiss="modal">保存</a> <a class="btn" data-dismiss="modal">关闭</a> </div>
</div>
